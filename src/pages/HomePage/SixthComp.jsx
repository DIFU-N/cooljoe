        ...
        <div className='py-32 w-full flex flex-col gap-y-4 items-center justify-center bg-[#f3c351]'>
            ...
            <div>
                <button className="cursor-pointer pl-5 pr-1 h-10 flex items-center font-bold group rounded-full bg-[#05070f] border border-transparent text-[#f3c351]">
                    <span className="text-lg md:text-base lg:text-lg font-semibold group-active:scale-95">CREATE ACCOUNT</span>
                    <svg className="w-[52px] md:w-12 lg:w-[52px] group-hover:translate-x-1 transition-transform duration-200 ease-in-out" viewBox="0 0 74 74" xmlns="http://www.w3.org/2000/svg">
