      ...
      <nav className="text-[#7b7e8e] grid grid-cols-2 gap-1 lg:grid-cols-[10.5%_69.5%_20%] lg:gap-x-[34px] overflow-hidden" style={divStyle}>
          ...
          <div id="navItems" className="z-50 transition duration-200 pt-8 ease-in-out -translate-y-full bg-opacity-[0.96]  left-0 top-0 bg-[#050710] py-7 lg:hidden absolute text-[14px]">
            ...
            <div className="lg:flex-row text-[12px] md:text-base flex flex-col justify-start items-start">
              <NavLink to="/" onClick={hideNavItems} className={'flex items-center font-semibold group relative'}>
              ...
              <NavLink to="/how-it-works" onClick={hideNavItems} className={'flex items-center font-semibold group relative'}>
              ...
              <NavLink to="/games" onClick={hideNavItems} className={'flex items-center font-semibold group relative'}>
                ...
                "px-2 py-1 group-hover:text-[#f3c351] bg-opacity-80 group-focus:text-[#f3c351] w-screen")}>Games</div>
              </NavLink>
